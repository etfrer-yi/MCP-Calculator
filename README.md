...
A scientific calculator built as an [MCP](https://modelcontextprotocol.io) server with a CLI client, using [FastMCP](https://github.com/jlowin/fastmcp).
...
.
├── calculator-mcp/
│   ├── server.py   # FastMCP server exposing calculator tools
│   └── client.py   # CLI client
├── calculator.md   # Quick reference
├── .gitignore
└── README.md
```
